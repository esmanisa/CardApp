                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return ListTile(
                            ...
                            leading: Image.asset("assets/${dijitalKartlarim[index]}.jpg"),
                            onTap: (){
                              Navigator.push(context,
                                  MaterialPageRoute(
                                      builder: (context)=>KartHareketleri(index)));
                            },);
      ...
      body:Column(
        ...
        children: [
          SafeArea(child: Container(
            ...
            child: Text("Kart Okutma:", style:  TextStyle(fontSize: 20),), color: Colors.black12,)),

          SafeArea(child: Container(
            padding: EdgeInsets.only(top: 3,bottom: 8) ,
            margin: EdgeInsets.all(8),
            child: Text("Ücret İadesi:", style:  TextStyle(fontSize: 20),), color: Colors.black12,))
        ],
      ),
    );
  }
